...
class Editor:
    def __init__(self):
        ...
        self.zoom_size = self.screen_size
    ...
    def run(self):
        while self.running:
            ...
            self.display.blit(pygame.transform.scale(self.background, [self.screen_size[0] / self.render_scale, self.screen_size[1] / self.render_scale]), (0, 0))

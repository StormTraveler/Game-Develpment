...
class Menu:
    def __init__(self, game, menu_type):
        ...
        if self.type == "Main Menu":
            ...
            self.buttons.append(Button(self.game, (100, 100, 200, 50), "Start", type="start"))
            self.buttons.append(Button(self.game, (100, 200, 200, 50), "Options", type="options"))
            self.buttons.append(Button(self.game, (100, 300, 200, 50), "Quit", type="quit"))
    ...
    def update(self):
        ...
        if not self.game.state == "Keybinds":
